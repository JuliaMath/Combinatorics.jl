...
export  catalan, derangement, fibonacci, hyperfactorial, multinomial,
        stirlings1, subfactorial, lucas, primorial, doublefactorial,
        multifactorial, legendresymbol, jacobisymbol
